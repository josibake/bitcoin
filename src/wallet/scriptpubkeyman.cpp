...
isminetype SilentPaymentDescriptorScriptPubKeyMan::IsMine(std::vector<XOnlyPubKey> output_keys, bip352::PublicData& public_data, std::map<XOnlyPubKey, std::optional<CPubKey>> &found_outputs)
{
    LOCK(cs_desc_man);
