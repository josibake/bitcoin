...
export TAR_OPTIONS="--owner=0 --group=0 --numeric-owner --mtime='@${SOURCE_DATE_EPOCH}' --sort=name --use-compress-program=bzip2"
export TZ="UTC"
...
NO_QT=1 make -C depends --jobs="$JOBS" HOST="$HOST" \
                                   ${V:+V=1} \
...
# CONFIGFLAGS
CONFIGFLAGS="--enable-reduce-exports --disable-bench --disable-gui-tests --disable-fuzz-binary --disable-tests --with-gui=no"
